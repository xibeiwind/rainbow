...
{
    /// <summary>
    ///     Contains a collection of converters that provides a way to convert the specific type to custom string bypassing
    ///     other rules.
    /// </summary>
    public class TypeConvertorCollection
    {
        ...
        {
            if (_convertors.ContainsKey(type)) return _convertors[type](type);
