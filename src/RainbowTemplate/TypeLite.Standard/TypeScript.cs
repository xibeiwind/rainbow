...
namespace TypeLite
{
    ...
    public class TypeScriptFluent
    {
        ...
        /// </summary>
        public TsModelBuilder ModelBuilder => _modelBuilder;

        /// <summary>
        ///     Gets the ModelBuilder being configured with fluent configuration.
        /// </summary>
        public TsGenerator ScriptGenerator => _scriptGenerator;
        ...
        /// <summary>
        ///     Generates TypeScript definitions for types included in this model builder. Optionally restricts output to classes
        ///     or enums.
        /// </summary>
    ...
    /// <summary>
    ///     Represents a wrapper around TsModelBuilder and TsGenerator that simplify usage a enables fluent configuration for
    ///     types.
    /// </summary>
    public class TypeScriptFluentModuleMember : TypeScriptFluent
    {
        ...
        {
            Member.Module = new TsModule(moduleName);
            return this;
        }
        ...
        {
            if (Member is TsClass) ((TsClass) Member).IsIgnored = true;
            return this;
        }
    }
}